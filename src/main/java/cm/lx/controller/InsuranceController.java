...
import cm.lx.bean.InsuranceExport;
...
public class InsuranceController extends BaseController {
    ...
    private List<Insurance> prepareData(List<Insurance> list) {
        for (Insurance insurance : list) {
            ...
            map.put("displayStatus", String.valueOf(ContextType.DISPLAY_STATUS_SHOW));
    ...
    public ModelAndView insuranceView(HttpSession session) {
        ...
        mav.addObject(DATA, prepareData(daoCenter.getInsuranceList(map)));
    ...
    public ModelAndView carSearchPurchase(
        ...
        if (StringUtils.isEmpty(searchKey)) {
            ...
            List<Insurance> list = prepareData(daoCenter.getInsuranceList(null));
            for (Insurance insurance : list) {
                if (searchKey.equals("consumerName")) {
                    ...
                    if (insurance.getList().size() == 0) continue;
        ...
        insuranceList.addAll(resultList);
        mav.setViewName("insurance/list");
    ...
    public ModelAndView insuranceAction(
        ...
        if (over == null) {
            if (id != null) {
                Insurance insurance = daoCenter.getInsurance(id);
                mav.addObject("id", id);
            ...
            if (action.equals(CREATE_ACTION)) {
                ...
                daoCenter.createInsurance(insurance);
            } else if (action.equals(MOD_ACTION)) {
                insurance.setId(id);
                daoCenter.updateInsurance(insurance);
            }
            mav.setViewName("redirect:/insuranceView");
            return mav;
        }
    ...
    public ModelAndView insuranceDelete(
        ...
        mav.setViewName("redirect:/insuranceView");
        //删除业务相关数据
        daoCenter.deleteInsuranceBusinessByInsuranceId(id);

        daoCenter.deleteInsurance(id);
        return mav;
    }
    ...
    public ModelAndView insuranceBusinessAction(
        ...
        if (over == null) {
            if (id != null) {
                InsuranceBusiness insuranceBusiness = daoCenter.getInsuranceBusiness(id);
                mav.addObject("id", id);
            ...
            if (action.equals(CREATE_ACTION)) {
                ...
                daoCenter.createInsuranceBusiness(insuranceBusiness);
            } else if (action.equals(MOD_ACTION)) {
                insuranceBusiness.setId(id);
                daoCenter.updateInsuranceBusiness(insuranceBusiness);
            }
            mav.setViewName("redirect:/insuranceView");
            return mav;
        }
    ...
    public ModelAndView insuranceBusinessDelete(
        ...
        ModelAndView mav = new ModelAndView();
        mav.setViewName("redirect:/insuranceView");
        daoCenter.deleteInsuranceBusiness(id);
        return mav;
    }

    @RequestMapping(value = "/insuranceExport", method = RequestMethod.GET)
    public ModelAndView insuranceExport(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ModelAndView mav = new ModelAndView();
        mav.setViewName("redirect:/insuranceView");
        ...
        List<InsuranceExport> list = new ArrayList<InsuranceExport>();
