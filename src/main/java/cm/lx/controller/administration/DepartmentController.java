...
public class DepartmentController extends BaseController {
    ...
    public ModelAndView addUser(
        ...
        if (over == null) {
            if (id != null) {
                DepartmentAuthority departmentAuthority = departmentAuthorityService.getDepartmentAuthorityById(id);
                mav.addObject("id", id);
            ...
            if (departmentAuthorityService.getDepartmentAuthorityByName(dname) != null && action.equals(CREATE_ACTION)) {
            ...
            if (action.equals(CREATE_ACTION)) {
                departmentAuthorityService.create(departmentAuthority);
                ...
                departmentAuthorityService.updateDepartmentAuthority(departmentAuthority);
    ...
    public ModelAndView deleteUser(
        ...
        //删除部门，删除部门下面所有成员
        departmentAuthorityService.deleteDepartmentAuthorityById(id);
