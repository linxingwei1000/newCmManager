package cm.lx.bean.export;

/**
 * Created by linxingwei on 2018/3/12.
 */
public class CarRecordExport {
    ...
    Double hallMoney;
    Double quanAuthorityMoney;
    Double anAuthorityMoney;
    Double carAgencyFee;
    String purchaseType;
    ...
    public void setCarChannel(String carChannel) {
    ...
    public String getCarTakeType() {
        return carTakeType;
    }

    public void setCarTakeType(String carTakeType) {
    ...
    public Double getCarAgencyFee() {
        return carAgencyFee;
    }

    public void setCarAgencyFee(Double carAgencyFee) {
        this.carAgencyFee = carAgencyFee;
    }
    ...
    public Double getQuanAuthorityMoney() {
        return quanAuthorityMoney;
    }

    public void setQuanAuthorityMoney(Double quanAuthorityMoney) {
        this.quanAuthorityMoney = quanAuthorityMoney;
    }

    public Double getAnAuthorityMoney() {
        return anAuthorityMoney;
    }

    public void setAnAuthorityMoney(Double anAuthorityMoney) {
        this.anAuthorityMoney = anAuthorityMoney;
    }
    ...
    public Double getCostOilFee() {
        return costOilFee;
    }

    public void setCostOilFee(Double costOilFee) {
        this.costOilFee = costOilFee;
    }

    public Double getCostCattleFee() {
        return costCattleFee;
    }

    public void setCostCattleFee(Double costCattleFee) {
        this.costCattleFee = costCattleFee;
    }
    ...
    public Double getCostOtherFee() {
        return costOtherFee;
    }

    public void setCostOtherFee(Double costOtherFee) {
        this.costOtherFee = costOtherFee;
    }
    ...
    public void setConsumerProperty(String consumerProperty) {
