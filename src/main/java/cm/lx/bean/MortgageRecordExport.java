...
/**
 * Created by linxingwei on 2018/2/14.
 */
public class MortgageRecordExport {
    ...
    public String getExpenseIsCompany() {
        return expenseIsCompany;
    }

    public void setExpenseIsCompany(String expenseIsCompany) {
